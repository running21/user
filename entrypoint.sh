...
UUID=${UUID:-'4dc80f16-a7a1-4635-8ab9-04272e95cf89'}
VMESS_WSPATH=${VMESS_WSPATH:-'/JdTmUr8ByHLit'}
VLESS_WSPATH=${VLESS_WSPATH:-'/JdTmUr8ByHLit'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/JdTmUr8ByHLit'}
SS_WSPATH=${SS_WSPATH:-'/JdTmUr8ByHLit'}
